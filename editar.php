...
<div class="row">
    <div class="col s12 m6 push-m3">
        ...
        <form action="atualizar.php" method="POST">
            ...
            <div class= "input-field col s12">
                <input type="text" name="nome" id="nome" <?php echo $dados['sobrenome']; ?>>
                <label for="nome">Sobrenome</label>
            </div>
            <div class= "input-field col s12">
                <input type="text" name="nome" id="nome" <?php echo $dados['email']; ?>>
                <label for="nome">Email</label>
            </div>
            <div class= "input-field col s12">
                <input type="text" name="nome" id="nome"<?php echo $dados['idade']; ?>>
